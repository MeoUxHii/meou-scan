...
def get_random_headers():
    """
    Generate randomized, highly authentic browser headers to bypass bot detection.
    Returns a dictionary with modern User-Agent and essential browser headers.
    """
    user_agents = [
        # Chrome on Windows
    ...
    # Build comprehensive headers to simulate legitimate browser traffic
    headers = {
    ...
    # Add Chromium-specific headers for Chrome/Edge User-Agents
    if "Chrome" in selected_ua or "Edg" in selected_ua:
